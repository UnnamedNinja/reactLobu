...
import AddOrderPopUpContractor from '../Add/addOrderPopUpContractor';

import EditOrderPopUp from '../Edit/editOrderPopUp';
import EditOrderPopUpContractor from '../Edit/editOrderPopUpContractor';
  ...
  getTableData = async (props) => {
    ...
    //Client orders
      ...
      let filteredOrders = response.allOrders.filter((order) => {
        return order.contractorId === this.props.currentContractor;
      });
            ...
            },
            {
              ...
              onClick: async (event, rowData) => {
                if (this.props.tableTitle === CLIENT_NAVIGATION_ROUTES[1]) {
                  ...
                  await this.setState({ selectedOrder: rowData });
                  this.handleOpenEdit();
                } else {
