...
class EditTable extends React.Component {
  ...
  getTableData = async (props) => {
    ...
    console.log('DATA RETRIEVED FROM MONGODB FOR ALL CLIENT IN POPER');
      ...
      <div>
        <MaterialTable
          ...
          actions={[
            {
              icon: 'add',
              tooltip: this.props.t('Select Client'),
              onClick: async (event, rowData) => {
                await this.props.callbackValue(
                  this.props.isEdit ? 'alternateInvoiceRecipient' : 'Alternate Invoice Recipient',
                  rowData,
                );
          ...
          columns={this.getColumns(CLIENT_TABLE_COLUMNS)}
