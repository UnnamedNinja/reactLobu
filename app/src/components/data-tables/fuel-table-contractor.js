...
class FuelTable extends React.Component {
  ...
  async componentDidMount(){
    alert(this.props.currentContractor)

    let prices = await this.props.getFuelPrice(this.props.currentContractor);
        ...
        <Button
          ...
          onClick={async() =>{
            if (this.state.isNewTable) {
              await this.setState({clientId:this.props.currentContractor})
              await this.props.addFuelPrice(this.state);
              await this.setState({isNewTable:false})
            }else{
              await this.props.editFuelPrice(this.props.currentContractor, this.state)}
            }
          }
        >
