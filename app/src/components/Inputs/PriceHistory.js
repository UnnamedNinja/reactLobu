                ...
                <tbody>
                  {this.state.data.map((row, index) => {
                    ...
                    if (this.props.isEdit) {
                      console.log("bowlsd");
                      console.log(Date.parse(row["validTo"]));
                      console.log(Date.parse(new Date(Date.now())));
                      if (Date.parse(row["validTo"]) < Date.parse(new Date(Date.now()))) {
                        isReadOnly = true;
                      }
                    ...
                    return (
                      <tr>
                        <td>
                          <input
                            onChange={(e) => this.handleChange(index, 'price', e.target.value)}
                            type="text"
...
export default connect(mapStateToProps, {})(withTranslation('common')(PriceHistoryTable));
