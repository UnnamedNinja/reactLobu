...
class EditSpecialOrderForm extends React.Component {
  ...
  getData = async (props) => {
    let contractorSpecialOrder = await props.getContractorSpecialOrder(
      props.selectedSpecialOrder._id,
    );
    this.currentEntity = contractorSpecialOrder.SpecialOrderFound;
    this.getSchema();
  };
      ...
      <div style={{ flexGrow: 1 }}>
        ...
        >
          <DialogTitle id="form-dialog-title">
            {this.props.t('Edit') + ' ' + this.props.t('Special Order')}
          </DialogTitle>
          <DialogContent>
          ...
          <DialogActions>
            ...
            <Button
              onClick={async () => {
                this.props.editContractorSpecialOrder(this.currentEntity._id, this.state);
                await this.getData(this.props);
                this.props.handleClose();
              }}
              color="primary"
