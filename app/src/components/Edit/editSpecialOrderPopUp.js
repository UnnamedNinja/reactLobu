...
class EditSpecialOrderForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      inputFields: [],
  ...
  getData = async (props) => {
    let clientSpecialOrder = await props.getClientSpecialOrder(props.selectedSpecialOrder._id);
    this.currentEntity = clientSpecialOrder.SpecialOrderFound;
    this.getSchema();
  };
  ...
  render() {
    return (
      <div style={{ flexGrow: 1 }}>
        ...
        >
          <DialogTitle id="form-dialog-title">{this.props.t('Edit Special Order')}</DialogTitle>
          <DialogContent>
          ...
          <DialogActions>
            ...
            <Button
              onClick={async () => {
                this.props.editClientSpecialOrder(this.currentEntity._id, this.state);
                await this.getData(this.props);
                this.props.handleClose();
              }}
              color="primary"
            >
              {this.props.t('Edit Special Order') +
                ' ' +
                this.props.t('For') +
                ' ' +
                this.props.t('Client')}
...
export default connect(mapStateToProps, {
  ...
  getPersonComponent,
  getInvoice,
})(form(withTranslation('common')(EditSpecialOrderForm)));
